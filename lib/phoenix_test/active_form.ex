defmodule PhoenixTest.ActiveForm do
  ...
  def prepend_form_data(active_form, default_form_data) do
    Map.update(active_form, :form_data, %{}, fn form_data -> Utils.deep_merge(default_form_data, form_data) end)
  end

  def add_form_data(active_form, new_form_data) do
    Map.update(active_form, :form_data, %{}, fn form_data -> Utils.deep_merge(form_data, new_form_data) end)
  end
